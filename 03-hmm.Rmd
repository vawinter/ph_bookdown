...
grid.arrange(p1,
  arrangeGrob(p2, p3, ncol = 2),
             nrow = 2)
```
These individuals are presenting different movements. The top plot shows a mirant individual, the bottom right shows a disperser, and the bottom left shows an individual whose movements are not able to be catagotized.
